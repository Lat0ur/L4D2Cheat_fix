...
void CAimbot::CompensateSpread( CUserCmd* cmd )
{
	...
	static auto uSharedRandomFloat = reinterpret_cast<std::uintptr_t>(GetModuleHandleA( "client.dll" )) + 0x1A8390;
	static auto SharedRandomFloat = reinterpret_cast<FnSharedRandomFloat>(uSharedRandomFloat);

	static auto UpdateMaxSpread = reinterpret_cast<FnUpdateMaxSpread>((reinterpret_cast<std::uintptr_t>(GetModuleHandleA( "client.dll" ))) + 0x2ECCB0);
